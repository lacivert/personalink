...
export const placeholderCVData: CVData = {
  ...
  contact: {
    email: "alex.persona@example.com",
    phone: "+1 (555) 123-4567",
    linkedin: "linkedin.com/in/alexpersona",
    github: "github.com/alexpersona",
    website: "alexpersona.dev"
  },
  experience: [
  ...
  projects: [
    { id: "proj1", name: "Personal Portfolio Website", description: "This very website, built with Next.js, Tailwind CSS, and ShadCN UI.", technologies: ["Next.js", "TypeScript", "Tailwind CSS", "ShadCN UI"], link: "https://github.com/alexpersona/personallink" },
    { id: "proj2", name: "Task Management App", description: "A full-stack task management application with user authentication and real-time updates.", technologies: ["React", "Node.js", "MongoDB", "Socket.io"], link: "https://github.com/alexpersona/taskmaster" },
  ]
};

export const placeholderLinks: LinkItem[] = [
  { id: "link1", title: "My GitHub", url: "https://github.com/alexpersona", description: "Check out my projects and contributions.", icon: Github, category: "Professional" },
  { id: "link2", title: "My LinkedIn", url: "https://linkedin.com/in/alexpersona", description: "Connect with me professionally.", icon: Linkedin, category: "Professional" },
  { id: "link3", title: "My Twitter / X", url: "https://twitter.com/alexpersona", description: "Follow my thoughts and updates.", icon: Twitter, category: "Social" },
...
export const socialLinks = [
  { href: "https://github.com/alexpersona", label: "GitHub", icon: Github },
  { href: "https://linkedin.com/in/alexpersona", label: "LinkedIn", icon: Linkedin },
  { href: "https://twitter.com/alexpersona", label: "Twitter", icon: Twitter },
];
